...
DO NOT OUTPUT ANY ADDITIONAL TEXT, NUMBERS OR LINE BREAKS EXCEPT THESE DEFINITION SENTENCES
The concept: {class_name}"""


PROMPT_TEMPLATE_SYNONYM_DEFINITION = """
I will provide you a concept and its defintion. You have to provide 2 or 3 scientific synonyms for that concept without providing a sentence.

DO NOT COUNT THE OUTPUT. DO NOT OUTPUT ANY ADDITIONAL TEXT, NUMBERS OR LINE BREAKS EXCEPT THIS SYNONYM
The concept: {class_name}
The definition: {definition}
Strip your answer to just containing the synonyms separated by comma. """

PROMPT_TEMPLATE_SYNONYM = """
I will provide you a concept. You have to provide 2 or 3 scientific synonyms for that concept without providing a sentence.

DO NOT COUNT THE OUTPUT. DO NOT ADD ANY ADDITIONAL TEXT, NUMBERS OR LINE BREAKS EXCEPT THIS SYNONYMS
The concept: {class_name}
Strip your answer to just containing the synonyms separated by comma. 
"""
...
DO NOT OUTPUT ANY ADDITIONAL TEXT, NUMBERS OR LINE BREAKS EXCEPT THESE WORDS
The concept: {class_name}
"""
...
DO NOT OUTPUT ANY ADDITIONAL TEXT, NUMBERS OR LINE BREAKS EXCEPT THIS ONTOLOGIES SEPARATED BY COMMA
The concept: {class_name}
The definition: {definition}
Strip your answer to just containing the ontologies separated by comma. """
...
I will provide a concept using all your knowledge identify the three best fitting ontologies from the list and return just their identifier.  

DO NOT OUTPUT ANY ADDITIONAL TEXT, NUMBERS OR LINE BREAKS EXCEPT THE ONTOLOGIES
The concept: {class_name}
Strip your answer to just containing the ontologies separated by comma.
"""
